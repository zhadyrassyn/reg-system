        ...
        <div className="row">
          <div className="col-md-12">
            ...
            <div className="form-group">
              ...
              <textarea className="form-control" id="generalInfoComment" rows="3" placeholder="Leave comment..." defaultValue={ generalInfoComment }></textarea>
            </div>
            <div>
        ...
        <div className="row mt-3">
          <div className="col-md-12">
            ...
            <div className="form-group">
              ...
              <textarea className="form-control" id="documentsComment" rows="3" placeholder="Leave comment..." defaultValue={ generalInfoComment }></textarea>
            </div>
            <div>
              <button className="btn btn-outline-success width120">Accept</button>
              <button className="btn btn-outline-danger width120 ml-2">Reject</button>
